...
public class DandelionFlowerBody : FlowerBody {
	...
	override public void Start () {
		...
		PutImagesInFront ();
		growthSize  = Random.Range (.4f, .45f);
	}
	...
	override public void Update () {
		...
		if (active) {
			...
			this.transform.GetChild (1).localScale = new Vector3 (scale, scale, 0f); 

			red = Mathf.Lerp (184f, 255f, (time / growthLength)) / 255f;
			green = Mathf.Lerp (193f, 255f, (time / growthLength)) / 255f;
			blue = Mathf.Lerp (17f, 255f, (time / growthLength)) / 255f;
