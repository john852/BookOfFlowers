...
public class OrchidBody : FlowerBody {
	...
	override public void Start () {
		...
		growthSize  = Random.Range (.38f, .45f);
	}
	...
	override public void Update () {
		...
		if (active) {
			...
			red = Mathf.Lerp (255f, 80f, (time / growthLength)) / 255f;
			green = Mathf.Lerp (255f, 80f, (time / growthLength)) / 255f;
			blue = Mathf.Lerp (255f, 80f, (time / growthLength)) / 255f;
